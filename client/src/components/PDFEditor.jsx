...
function PDFEditor({ document: pdfDocument }) {
  ...
  const pdfUrl = `https://document-signature-app-lgxn.onrender.com/${pdfDocument.file_path}`;
  ...
  const loadLatestSignature = async () => {
    try {
      ...
      console.log("Latest Signature:", response.data.path);
  ...
  const loadSignaturePosition = async () => {
    try {
  ...
  const handleMouseDown = (e) => {
    ...
    const initialX = signaturePos.x;
    const initialY = signaturePos.y;
    ...
    const handleMouseUp = async (e) => {
      const finalX = initialX + (e.clientX - startX);
      const finalY = initialY + (e.clientY - startY);
      ...
      await saveSignature(finalX, finalY);
    };
